...
import Std from '../cards/files/Students.xls'
import Emp from '../cards/files/Employee.xls'
import IMDB from '../cards/files/IMDb.xls'
import Med from '../cards/files/Medical.xls'
import Dress from '../cards/files/Clothes.xls'
import Stock from '../cards/files/Indian.xls'
import Tech from '../cards/files/Tech.xls'
import Clg from '../cards/files/Colleges.xls'
                ...
                <div className="col-lg-3 col-md-6 mb-4 ">
                    <div className="card h-100 cards">
                        ...
                        <div className="card-body">
                            ...
                            <a className="btn-block download-btn text-decoration-none text-dark" href={Std} download="Students Data.xls">
                                Download
                            </a>
                        </div>
                    </div>
                ...
                <div className="col-lg-3 col-md-6 mb-4">
                    <div className="card h-100 cards">
                        ...
                        <div className="card-body">
                            ...
                            <a className="btn-block download-btn text-decoration-none text-dark" href={Emp} download="Employee Data.xls">
                                Download
                            </a>
                        </div>
                    </div>
                ...
                <div className="col-lg-3 col-md-6 mb-4">
                    <div className="card h-100 cards">
                        ...
                        <div className="card-body">
                            ...
                            <a className="btn-block download-btn text-decoration-none text-dark" href={IMDB} download="IMDb Data.xls">
                                Download
                            </a>
                        </div>
                    </div>
                ...
                <div className="col-lg-3 col-md-6 mb-4">
                    <div className="card h-100 cards">
                        ...
                        <div className="card-body">
                            ...
                            <a className="btn-block download-btn text-decoration-none text-dark" href={Med} download="Medical Data.xls">
                                Download
                            </a>
                        </div>
                    </div>
                ...
                <div className="col-lg-3 col-md-6 mb-4">
                    <div className="card h-100 cards">
                        ...
                        <div className="card-body">
                            ...
                            <a className="btn-block download-btn text-decoration-none text-dark" href={Dress} download="Accessories Data.xls">
                                Download
                            </a>
                        </div>
                    </div>
                ...
                <div className="col-lg-3 col-md-6 mb-4">
                    <div className="card h-100 cards">
                        ...
                        <div className="card-body">
                            ...
                            <a className="btn-block download-btn text-decoration-none text-dark" href={Stock} download="Indian Stock Data.xls">
                                Download
                            </a>
                        </div>
                    </div>
                ...
                <div className="col-lg-3 col-md-6 mb-4">
                    <div className="card h-100 cards">
                        ...
                        <div className="card-body">
                            ...
                            <a className="btn-block download-btn text-decoration-none text-dark" href={Tech} download="Tech Data.xls">
                                Download
                            </a>
                        </div>
                    </div>
                ...
                <div className="col-lg-3 col-md-6 mb-4">
                    <div className="card h-100 cards">
                        ...
                        <div className="card-body">
                            ...
                            <a className="btn-block download-btn text-decoration-none text-dark" href={Clg} download="Colleges Data.xls">
                                Download
                            </a>
                        </div>
                    </div>
