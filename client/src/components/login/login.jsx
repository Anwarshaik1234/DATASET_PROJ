        ...
        <div className="container d-flex justify-content-center align-items-center vh-100">
          <div className="col-md-6">
              <form className="w-100 p-4 shadow rounded bg-white" onSubmit={handleSubmit} >
                <h2 className="text-center">myData Login</h2>
                ...
                <div className="text-center mt-3">
                  <Link to="/forgot-password" className="pass-col">Forgot Password?</Link>
                </div>
                <p className="text-center mt-2">
                  Don't have an Account? <Link to="/signup" className="sign-col">Sign up</Link>
                </p>
              </form>
            </div>
          </div>
