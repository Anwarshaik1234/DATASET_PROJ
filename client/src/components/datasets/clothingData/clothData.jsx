...
const Clothesdata = () => {
    ...
    const {onDownload} = useDownloadExcel({
        ...
        filename: 'Accessories Data',
        sheet: 'Accessories Data',
    })
    ...
    const generathPDF = useReactToPrint({
        ...
        documentTitle: 'Accessories Data',
    ...
    return (
        <div>
            <Navbar /> 
            <br/><br /><br />
            <h2 className="text-center text-des">Accessories Data</h2>
            <br/>
            ...
            <div className="d-grid gap-2 d-md-flex justify-content-md-end">
                ...
                <button className="btn btn-outline-success" type="button" >
                    <CSVLink data={clothdata} filename={"Accessories Data"} className="bl">CSV</CSVLink>
                </button>
